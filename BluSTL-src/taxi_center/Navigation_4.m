...
classdef Navigation_4 < handle
    ...
    methods
        function Obj = Navigation_4()
            % Constructor of Navigation level.
            Obj.taxi_sys = taxi_navigation_2();
            %Obj.taxi_sys.x0 = [0.1; 0; 0.5; 0];
            Obj.taxi_sys.x0 = [0.1;0.5];
        ...
        function callback(Obj, ~, data)
            ...
            %Obj.taxi_sys.addSpec('alw_[0, Inf] (w1(t)>0.5 => x1(t)<w2(t)-0.3 or x1(t)>w2(t)+0.3 or x3(t)<w3(t)-0.3 or x3(t)>w3(t)+0.3)');
            Obj.taxi_sys.addSpec('alw_[0, Inf] (w1(t)>0.5 => x1(t)<w2(t)-0.3 or x1(t)>w2(t)+0.3 or x2(t)<w3(t)-0.3 or x2(t)>w3(t)+0.3)');
