...
# from dumpsmach_2 import write_python_case_2, python_case_2
...
env_vars["car_0_succeed"] = 'boolean'
env_vars["car_1_succeed"] = 'boolean'
...
## TODO: improve simplicity
#env_safe |= {'car_0_full -> <> car_0_succeed'} # ev
#env_safe |= {'car_1_full -> <> car_1_succeed'} # ev
env_vars["temp_0"] = 'boolean'
env_vars["temp_1"] = 'boolean'

env_prog = {'temp_0'}
env_prog |= {'temp_1'}
env_init |= {'temp_0', 'temp_1'}
env_safe |= {'X(temp_0) <-> (car_0_succeed || (temp_0 && !car_0_full))'}
env_safe |= {'X(temp_1) <-> (car_1_succeed || (temp_1 && !car_1_full))'}

env_safe |= {'car_0_full -> X(!car_0_succeed -> car_0_full)'}
env_safe |= {'car_1_full -> X(!car_1_succeed -> car_1_full)'}
...
sys_vars['car_0'] = (0, 3)
sys_vars['car_1'] = (0, 3)
sys_vars["car_0_full"] = 'boolean'
sys_vars["car_1_full"] = 'boolean'
