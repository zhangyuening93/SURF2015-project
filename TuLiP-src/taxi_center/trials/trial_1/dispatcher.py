...
env_vars["succeed_car_0"] = 'boolean'
env_vars["succeed_car_1"] = 'boolean'
env_vars["full_car_0"] = 'boolean'
env_vars["full_car_1"] = 'boolean'

env_init = {'!req_1 && !req_2 && !req_3'}
env_init |= {'!succeed_car_0 && !succeed_car_1'}
...
#env_safe |= {'full_car_0 -> <> succeed_car_0'} # ev
#env_safe |= {'full_car_1 -> <> succeed_car_1'} # ev
...
env_safe |= {'X(temp_0) <-> (succeed_car_0 || (temp_0 && !full_car_0))'}
env_safe |= {'X(temp_1) <-> (succeed_car_1 || (temp_1 && !full_car_1))'}

env_safe |= {'full_car_0 -> X(!succeed_car_0 -> full_car_0)'}
env_safe |= {'full_car_1 -> X(!succeed_car_1 -> full_car_1)'}
...
# sys_vars |= {'temp2_0', 'temp2_1', 'temp2_2'}
