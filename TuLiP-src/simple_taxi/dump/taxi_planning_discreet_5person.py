...
#env_safe |= {'(!(pick && loc_3) && req_3) -> X(req_3)'}
#env_safe |= {'(pick && loc_4 && req_4) -> X(!req_4)'}
#env_safe |= {'(!(pick && loc_4) && req_4) -> X(req_4)'}
...
#sys_safe |= {'X(temp_0_2) <-> (des || (temp_0_2 && !wait_0))'}
sys_safe |= {'X(temp_1_1) <-> ((loc_1 && pick) || (temp_1_1 && !req_1))'}
#sys_safe |= {'X(temp_1_2) <-> (des || (temp_1_2 && !wait_1))'}
sys_safe |= {'X(temp_2_1) <-> ((loc_2 && pick) || (temp_2_1 && !req_2))'}
#sys_safe |= {'X(temp_2_2) <-> (des || (temp_2_2 && !wait_2))'}

sys_safe |= {'X(temp_0_2) <-> (des || (temp_0_2 && !wait_0 && !wait_1 && !wait_2))'}

#sys_safe |= {'X(temp_3_1) <-> ((loc_3 && pick) || (temp_3_1 && !req_3))'}
#sys_safe |= {'X(temp_3_2) <-> (des || (temp_3_2 && !wait_3))'}
#sys_safe |= {'X(temp_4_1) <-> ((loc_4 && pick) || (temp_4_1 && !req_4))'}
#sys_safe |= {'X(temp_4_2) <-> (des || (temp_4_2 && !wait_4))'}


sys_safe |= {'full -> !pick'}
#sys_safe |= {'pick -> ((loc_0 && req_0)||(loc_1 && req_1)||(loc_2 && req_2)||(loc_3 && req_3)||(loc_4 && req_4))'}

sys_safe |= {'pick -> ((loc_0 && req_0)||(loc_1 && req_1)||(loc_2 && req_2))'}
...
#sys_safe |= {'(pick && loc_4 && req_4) -> X(wait_4)'}
#sys_safe |= {'des -> X(!wait_4)'}
#sys_safe |= {'(wait_4 && !des) -> X(wait_4)'}
